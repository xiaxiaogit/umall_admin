  ...
  methods: {
    ...
    look(id) {
      ...
      reqSeckDetail(id).then(res => {
        console.log(res);
        let begin = new Date(parseInt(res.data.list.begintime));
        let end = new Date(parseInt(res.data.list.endtime));

        console.log(begin, end, this.form);
        this.form.value1 = [begin, end];
